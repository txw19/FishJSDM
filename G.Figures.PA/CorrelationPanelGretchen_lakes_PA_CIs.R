...
ERCIU <- ERCIU[!is.na(ERCIU)]
 ...
 sppnames <- c("black bullhead","black crappie", "bowfin", "brown bullhead", "common carp","golden shiner","green sunfish","largemouth bass","northern pike", "rock bass","smallmouth bass","walleye","white sucker","yellow bullhead","yellow perch","Lepomis","coldwater")
...
ggsave("environmental_and_residual_correlations_by_species_PA_significant.png", height=12, width=10, units="in")
...
res<-6
tiff(filename = 'env_corr_mn_lakes.tiff', height = 500*res, width = 500*res, res=72*res)
...
ggsave("AUC_conditional_marginal_lakes.png", height=12, width=8, units="in")
